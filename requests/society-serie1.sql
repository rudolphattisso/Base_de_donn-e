...
/*8*/
select last_name, first_name from employee e where last_name > first_name ;
...
/*22*/ 
select last_name, salary, commission_rate, title from employee where commission_rate notnull  ;
...
/*26*/
select last_name, salary, commission_rate, (salary * commission_rate / 100) AS commission from employee where commission_rate is not null order by commission_rate asc ;

/*27*/
select concat(last_name,'',first_name) as Complete_Name from employee ;

/*28*/
select substring(last_name, 1,5)from employee ;

/*29*/
select last_name ,position('r' in last_name)from employee e 

/*30*/
select last_name upper(last_name), lower(last_name) from employee e  where last_name ='Vrante'
